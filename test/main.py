...
def run() -> None:
    ...
    #print("test_request_line_too_long timeout?")
    run_test("GET /{A*10^10} HTTP/1.1", test_request_line_too_long) #time out?
    ...
    run_test("Testing read content & trailer \n POST /post/print.cgi HTTP/1.1\r\nHost: localhost\r\nTransfer-encoding: chunked\r\n\r\n" , test_chunked_w_trailer)
    ...
    run_test("GET /auto, Host: default_server", test_get_dir_no_index)
    run_test("GET /auto, Host: google.com", test_get_dir_autoindex)
    run_test("GET /, Host: google.com", test_get_dir_index)
